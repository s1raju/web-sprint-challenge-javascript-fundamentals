...
// The nested function can access the variable internal because both are in the same closure. 
...
const zooAnimals = [
  ...
  */
  function lowerCaseNames(){
    let lcNames = zooAnimals.map(function (item){
  ...
  */
  ...
  function lowPopulationAnimals(){
    let lPAnimals = zooAnimals.filter(function (item){
  ...
  */
  ...
  function USApop(){
    let totPop = zooAnimals.reduce(function(accumulator, item){
...
function greeting(a, b){
  ...
  console.log(greeting("Britt", "Murphy"));
